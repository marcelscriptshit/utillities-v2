...
function ESP:GetColorNames(obj)
    ...
    local p = self:getPlayerFromChar(obj)
...
function ESP:Add(obj, options)
    ...
    local box = setmetatable({
        ...
        Object = obj,
        Player = options.Player or ESP:getPlayerFromChar(obj),
        PrimaryPart = options.PrimaryPart or obj.ClassName == "Model" and (obj.PrimaryPart or obj:FindFirstChild("Root") or obj:FindFirstChildWhichIsA("BasePart")) or obj:IsA("BasePart") and obj,
        Components = {},
        IsEnabled = options.IsEnabled,
...
local function CharAdded(char)
    local p = ESP:getPlayerFromChar(char)
